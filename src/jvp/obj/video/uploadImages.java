...
public class uploadImages implements Serializable{
    ...
    public List<uploadImagesBean> upload(FileUploadEvent event) throws IOException {
    ...
    public String copyFile(String fileName, InputStream in,int cnt) {
        ...
        String str = path+"/" + 
                ...
                reusableObj.paddingString(""+(cnt++), 6, '0', true)+"_"+
                reusableObj.getUnixName(fileName.toLowerCase(),"")+ext.toLowerCase();
